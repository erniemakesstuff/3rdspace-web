    ...
    <SectionLayout id="mission">
      <div className="grid items-center gap-12 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-4 text-lg leading-relaxed text-foreground/90">
            We want to see people thriving at their local community center, library, church, social club, “p-patch”, food-forest, or park – in short, all of “the commons” that we share - not sitting at home, alone, doom scrolling or swiping for the next superficial connection. We also mourn the decline of for-profit shared spaces where profit-motive is often in conflict with human connection.
          </p>
          <p className="mt-4 text-lg font-semibold leading-relaxed text-primary">
            We want third spaces. Spaces where people can meet, socialize, and organize for common goals.
          </p>
          <p className="mt-4 text-lg leading-relaxed text-foreground/90">
            We are intentionally neutral on the goals of all individuals. Our focus is: Are you inhabiting third spaces, and are you connecting meaningfully with other people?
          </p>
        </div>
