      ...
      <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
        <div className="space-y-6 text-center lg:text-left">
          ...
          <p className="text-lg text-foreground/80 md:text-xl">
            Tired of superficial connections? Third Space Connector helps you find and build genuine community in your local third spaces. Offer your skills, find support, and tackle shared goals together.
          </p>
